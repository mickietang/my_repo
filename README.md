...
This readme file was generated on 2023-03-06 by Mickie Tang
...
Title of Dataset: Heat and Trees in Sac

<provide at least two contacts> Author/Principal Investigator
Information Name: Mickie Tang ORCID: 0000-0001-6895-9849 Institution: University of California, Davis Address: Email: mcktang@ucdavis.edu

Author/Associate or Co-investigator Information Name: ORCID:
...
Geographic location of data collection: Sacramento, California, USA\<provide latitude, longiute, or
...
File List: \<list all files (or folders, as appropriate for dataset
...
Are there multiple versions of the dataset? If yes, name of file(s) that
was updated: Why was the file updated? When was the file updated?
...
value labels as appropriate for each; use `variable` to format as inline
code\>
